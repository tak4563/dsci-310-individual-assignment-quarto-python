...
![Horse populations for all provinces in Canada from 1906 - 1972.](../results/horse_pops_plot.png){width=90% fig-align="middle"}
...
We present the standard deviations in Table 1. @tbl-horses_sd.
...
![](../results/horse_pops_plot_largest_sd.png){width=60% fig-align="middle"}
